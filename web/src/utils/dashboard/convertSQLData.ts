...
export const convertSQLData = (
  ...
  switch (panelSchema.type) {
    ...
    case "area": {
      ...
      if((panelSchema.type == "area-stacked")||((panelSchema.type == "line" ||panelSchema.type == "area")&& panelSchema.queries[0].fields.y.length == 1 && panelSchema.queries[0].fields.x.length == 2)){
